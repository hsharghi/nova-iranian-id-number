...
Nova.booting(function (Vue, router) {
    Vue.component('index-iranian_id_number', __webpack_require__(3));
    Vue.component('detail-iranian_id_number', __webpack_require__(6));
    Vue.component('form-iranian_id_number', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    inputClass: function inputClass() {
      var classList = 'w-full form-control form-input form-input-bordered';
  ...
  methods: {
    ...
    checkIdNumber: function checkIdNumber() {

      var id = this.value.trim();
      if (!/^\d{10}$/.test(id) || id == '0000000000' || id == '1111111111' || id == '2222222222' || id == '3333333333' || id == '4444444444' || id == '5555555555' || id == '6666666666' || id == '7777777777' || id == '8888888888' || id == '9999999999') {
        this.hasError = true;
        return;
      }
